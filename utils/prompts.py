"""
Prompt templates for visual web understanding tasks.

This module contains all the prompt templates used for different tasks in the
VisualWebBench benchmark. Each prompt is designed to elicit specific responses
from vision-language models for tasks like web captioning, OCR, element grounding,
action prediction, and visual question answering.
"""
